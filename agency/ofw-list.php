            ...
            <form method="POST">
                ...
                <div class="form-group">
                    ...
                    <div class="cs-wrapper">
                        <input type="text" id="ol-country-search" class="form-control cs-input" placeholder="Search country..." autocomplete="off" required>
                        <input type="hidden" name="country" id="ol-country-value">
                        <div class="cs-dropdown" id="ol-country-dropdown"></div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="cs-wrapper">
                        <input type="text" id="ol-city-search" class="form-control cs-input" placeholder="Select country first..." autocomplete="off" disabled>
                        <input type="hidden" name="city" id="ol-city-value">
                        <div class="cs-dropdown" id="ol-city-dropdown"></div>
                    </div>
                </div>
...
<script>
/* ===== Country / City Searchable Dropdown (ofw-list) ===== */
(function() {
    const STYLE = `
    ...
    document.addEventListener('DOMContentLoaded', async function() {
        ...
        initSearchable('ol-country-search','ol-country-dropdown','ol-country-value',
            async (q) => q ? allCountries.filter(c => c.toLowerCase().includes(q)) : allCountries,
            async (selected) => {
                currentCountry = selected;
                const cityInput = document.getElementById('ol-city-search');
                cityInput.disabled = false;
                cityInput.placeholder = 'Loading cities...';
                cityInput.value = '';
                document.getElementById('ol-city-value').value = '';
        ...
        initSearchable('ol-city-search','ol-city-dropdown','ol-city-value',
            async (q) => {
