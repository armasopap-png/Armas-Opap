...
/**
 * ARMAS Agency — OFW Location Tracking
 * Shows only this agency's assigned OFWs
 */
session_start();
        ...
        <div class="tracking-layout">
            <div class="tracking-sidebar">
                <div class="tracking-header">
                    <h2>📍 OFW Locations</h2>
                    <p><?php echo count($ofws); ?> OFWs assigned to your agency</p>
                </div>
                <div class="tracking-search">
                    <input type="text" id="searchOfw" placeholder="Search by name or country..." onkeyup="filterCards()">
                </div>
