...
if (!$agency_id) { header('Location: /armas/admin/agency-cases.php'); exit; }

$agency = $pdo->prepare("SELECT * FROM agencies WHERE id = ?");
$agency->execute([$agency_id]);
$agency = $agency->fetch();
if (!$agency) { header('Location: /armas/admin/agency-cases.php'); exit; }
    ...
    <main class="main-content">
        <header class="main-header">
            <div class="main-header-title">
                <a href="/armas/admin/agency-cases.php" style="color:#1a3a6b; text-decoration:none; font-size:0.9rem;">← Agency Cases</a>
