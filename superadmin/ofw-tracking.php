      ...
      <div class="tracking-sidebar">
        <div class="tracking-header">
          ...
          <div class="legend">
            ...
            <span><span class="ldot" style="background:#94a3b8"></span> Never logged in</span>
          </div>
        </div>
