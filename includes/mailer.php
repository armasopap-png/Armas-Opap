...
function send_email($to_email, $to_name, $subject, $body)
{
    ...
    $smtp_username = 'reananbanta@gmail.com'; // Change this
    $smtp_password = 'libf cfem mumn uznz';    // Change this - use App Password for Gmail
    $smtp_secure = 'tls';
    $smtp_port = 587;
    $from_email = 'reananbanta@gmail.com';
