...
<head>
    ...
    <title><?php echo isset($page_title) ? $page_title . ' — ARMAS' : 'ARMAS — Assistance and Repatriation Management and Action System'; ?></title>
...
<nav class="navbar">
    <div class="navbar-container">
        <a href="<?php echo isset($is_portal) ? '/armas/pages/landing.php' : '/armas/pages/landing.php'; ?>" class="navbar-brand">
